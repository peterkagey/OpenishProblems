...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}
    \draw (0,0) grid (5,5);
    \draw[line width=5, dashed, orange!70] (2,5)--(4,5);
    \draw[line width=5, dashed, red!70] (5,0)--(5,2);
    \draw[line width=5, dashed, gray!70] (5,4)--(5,5);
    \draw[line width=5, ->, red!70] (0,0)--(0,2)--(2,2)--(2,5.1);
    \draw[line width=5, ->, orange!70] (2,0)--(4,0)--(4,3)--(5.1,3);
    \draw[line width=5, ->, orange!70] (2,0)--(4,0)--(4,3)--(5.1,3);
    \draw[line width=5, ->, red!70] (2,0)--(2,0.1);
    \draw[line width=5, ->, magenta!70] (0,3)--(1,3)--(1,5.1);
    \draw[line width=5, ->, orange!70] (0,3)--(0.1,3);
    \draw[line width=5, ->, blue!70] (1,0)--(1,1)--(3,1)--(3,4)--(5.1,4);
    \draw[line width=5, ->, magenta!70] (1,0)--(1,0.1);
    \draw[line width=5, ->, gray!70] (0,4)--(0,5.1);
    \draw[line width=5, ->, blue!70] (0,4)--(0.1,4);
  \end{tikzpicture}
