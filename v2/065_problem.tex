...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}[
    ...
    level 1/.style={level distance=2.2cm},
    level 2/.style={level distance=2.8cm},
    level 4/.style={level distance=3.2cm}
  ]
    \node {
...
\begin{references}
  ...
  \item \url{https://www.youtube.com/watch?v=_pP_C7HEy3g}
  \item \href{https://www.jstor.org/stable/24931273}{Martin Gardner, SciAm, Feb 1966}
\end{references}
\end{document}
