...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}[scale = 3.0]
    \fill[opacity=0.75, ultra thick, blue] (0,0) rectangle (1,1);
    \fill[opacity=0.35, ultra thick, red] (0.1463711037, 0.1463711037)--(0.853628, 0.853628)--({0.5 + sqrt(3)/2/sqrt(2)},{0.5 - sqrt(3)/2/sqrt(2)})--cycle;
  \end{tikzpicture}
  \caption{
    Six (all?) classes of intersections between a $4$-gon and a $3$-gon. The
