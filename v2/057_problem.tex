...
\begin{document}
\rating{2}{3}
Consider equivalence classes of polygonal chains on $n$ segments where
\begin{enumerate}[(1)]
...
\begin{figure}[ht!]
  \centering
  \begin{tikzpicture}
    \draw[line width=0.1cm] (0,0)--(0,1)--(1,1)--(1,0)--cycle;
  ...
  \end{tikzpicture}\hspace{1cm}
  \begin{tikzpicture}
    \draw[line width=0.1cm] (0, 0)--(1,1)--(1,0)--cycle;
    \draw[line width=0.1cm] (0, 0)--(2,1);
  \end{tikzpicture}\hspace{1cm}
  \begin{tikzpicture}
    \draw[line width=0.1cm] (0, 0)--(1,1)--(0,1)--(1,0)--cycle;
  \end{tikzpicture}\hspace{1cm}
  \begin{tikzpicture}
