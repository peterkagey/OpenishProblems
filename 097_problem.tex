...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}
    ...
    \draw[red,ultra thick] (0,0)--(1,1)--(2,0)--cycle;
  \end{tikzpicture}
  ~
  \begin{tikzpicture}
    \draw[gray] (0,0) grid (2,1);
    \draw[red,ultra thick] (0,0) rectangle (2,1);
    \draw[red,ultra thick] (0,0)--(1,1)--(2,0)--cycle (1,0)--(1,1);
  \end{tikzpicture}
  ~
  \begin{tikzpicture}
    \draw[gray] (0,0) grid (2,1);
    \draw[red,ultra thick] (0,0) rectangle (2,1);
    \draw[red,ultra thick] (0,0)--(1,1)--(1,0)--(2,1);
  \end{tikzpicture}
  ~
  \begin{tikzpicture}
    \draw[gray] (0,0) grid (2,1);
...
\begin{figure}[ht!]
  ...
  \begin{tikzpicture}
    ...
    \draw[blue!50,ultra thick]
      (0,0)--(2,3)--(3,2)--(0,0)--(4,0)--(2,4)--(1,4)--(2,3)--(0,1)--(0,0)
      (0,1)--(0,4)--(1,4)--cycle
      (2,4)--(4,4)--(4,0)
      (0,0)--(2,2)--(2,3)
      (2,2)--(3,2)
