...
\begin{figure}[!h]
  ...
  \begin{tikzpicture}[scale=0.5]
    ...
    \draw[red, very thick] (1, 1) -- (3, 2);
    \draw[red, very thick] (2, 1) -- (3, 2);
...
% --------------------------------------------
    ...
    \draw[blue, very thick] (7, 1) -- (8, 1);
    \draw[blue, very thick] (7, 1) -- (9, 2);
    \draw[blue, very thick] (8, 1) -- (10, 2);
    \draw[blue, very thick] (9, 2) -- (10, 2);
    ...
    \draw[magenta, very thick] (14, 1) -- (16, 1);
    \draw[magenta, very thick] (14, 1) -- (15, 3);
    \draw[magenta, very thick] (15, 3) -- (17, 4);
    \draw[magenta, very thick] (16, 1) -- (19, 2);
    \draw[magenta, very thick] (17, 4) -- (18, 4);
    \draw[magenta, very thick] (18, 4) -- (20, 3);
    \draw[magenta, very thick] (19, 2) -- (20, 3);

  \end{tikzpicture}
  \caption{Examples of $a(3) = 2$, $a(4) = 2$, and $a(7) = 4$.}
\end{figure}
