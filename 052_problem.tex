...
\begin{document}
  ...
  \begin{figure}[!h]
    ...
    \begin{tikzpicture}
      ...
      \draw[very thick, fill={yellow}, fill opacity=0.5] (1,0)--(1,1)--(2,0)--cycle;
    \end{tikzpicture}\hspace{1cm}
    \begin{tikzpicture}
      \draw[very thick, fill={red}, fill opacity=0.5] (0,0)--(1,0)--(1,1)--cycle;
      \draw[very thick, fill={red}, fill opacity=0.5] (1,0)--(1,1)--(2,1)--cycle;
    \end{tikzpicture}
    \begin{tikzpicture}
      \draw[very thick, fill={red}, fill opacity=0.5] (0,0)--(1,0)--(0,1)--cycle;
      \draw[very thick, fill={red}, fill opacity=0.5] (1,0)--(1,1)--(0,1)--cycle;
    \end{tikzpicture}\hspace{1cm}
    \begin{tikzpicture}
      \draw[very thick, fill={blue}, fill opacity=0.5] (-1,0)--(0,0)--(0,1)--cycle;
      \draw[very thick, fill={blue}, fill opacity=0.5] (0,0)--(1,0)--(0,1)--cycle;
      \draw[very thick, fill={blue}, fill opacity=0.5] (1,0)--(1,1)--(0,1)--cycle;
      \draw[very thick, fill={blue}, fill opacity=0.5] (0,1)--(1,1)--(1,2)--cycle;
    \end{tikzpicture}
    \caption{
