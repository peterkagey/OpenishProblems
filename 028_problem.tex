...
\begin{figure}[!h]
  ...
  \begin{tikzpicture}
    ...
    \fill[fill={rgb:red,0.5;yellow,4;blue,0.5}] (0, 0) rectangle (5, 6);
    \fill[fill={rgb:red,2;yellow,2;blue,0}] (0, 0) rectangle (2, 3);
    \fill[fill={rgb:red,3;green,1;blue,1}] (0, 3) rectangle (1, 5);
    \fill[fill={rgb:red,2;green,3;blue,0}] (0, 5) rectangle (2, 6); \fill[fill={rgb:red,2;green,3;blue,0}] (1, 4) rectangle (3, 5);
    \fill[fill={rgb:red,2;green,0;blue,3}] (4, 0) rectangle (5, 1);
    \fill[fill={rgb:red,2;green,0;blue,3}] (4, 0) rectangle (5, 2);
    \fill[fill={rgb:red,0;green,2;blue,3}] (3, 1) rectangle (4, 2);
    \fill[fill={rgb:red,0;green,3;blue,2}] (4, 3) rectangle (5, 6);
